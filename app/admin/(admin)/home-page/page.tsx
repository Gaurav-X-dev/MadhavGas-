...
export default function HomePageContentPage() {
  ...
  return (
    <div className="animate-fade-in-up pb-24">
      ...
      <div className="sticky bottom-0 z-20 -mx-4 mt-8 border-t bg-background/95 px-4 py-4 shadow-[0_-14px_35px_rgba(8,47,87,0.08)] backdrop-blur md:-mx-5 md:px-5 lg:-mx-6 lg:px-6 xl:-mx-8 xl:px-8">
