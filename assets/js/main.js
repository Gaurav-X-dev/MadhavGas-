            ...
            <div class="container nav-wrap">
                <a
                    ...
                    ><span class="brand-text"
                        ><strong>${agencyInfo.name}</strong
                        ><small>Trusted LPG Service Partner</small></span
                    ></a
                ><button
                    class="menu-toggle"
    ...
    return /* HTML */ `<section class="newsletter-section reveal">
        ...
        <section class="cta section-sm">
            <div class="container cta-inner">
                <div>
                    <h2>Need Assistance With Your LPG Service?</h2>
                    <p>Our customer support team is ready to help.</p>
                </div>
                <div class="action-row">
                    ...
                    ><a
                        ...
                        target="_blank"
                        rel="noopener"
                        href="https://wa.me/${agencyInfo.whatsapp}?text=Hello%20Bharat%20Gas%20Agency%2C%20I%20need%20LPG%20assistance."
                    ...
                    <div>
                        <a class="brand" href="index.html"
                            ...
                            ><span class="brand-text"
                                ...
                                ><small
                                    >Trusted LPG Service Partner</small
                                ></span
                            ></a
                        >
                        <p style="margin-top:18px">
                            Trusted household LPG distribution with safety,
                    ...
                    <div>
                        ...
                        <p>
                            ...
                            ><br /><a href="mailto:${agencyInfo.email}"
                                >${agencyInfo.email}</a
                            ><br /><a
                                href="https://wa.me/${agencyInfo.whatsapp}?text=Hello%20Bharat%20Gas%20Agency%2C%20I%20need%20support."
                                target="_blank"
                                rel="noopener"
                                >WhatsApp Support</a
                            >
        ...
        <footer class="footer premium-footer">
            ...
            <div class="container">
                <div class="footer-support-bar reveal-up">
                    ...
                    <div class="footer-support-actions"><a href="tel:${agencyInfo.phoneLink}"><span data-icon="phone"></span>${agencyInfo.phone}</a><a class="footer-whatsapp" target="_blank" rel="noopener" href="https://wa.me/${agencyInfo.whatsapp}?text=Hello%20Bharat%20Gas%20Agency%2C%20I%20need%20LPG%20assistance."><span data-icon="whatsapp"></span>Chat on WhatsApp</a></div>
                </div>
                <div class="footer-grid premium-footer-grid">
                    <div class="footer-about">
                        <a class="brand footer-brand" href="index.html"><span class="brand-mark" data-icon="flame"></span><span class="brand-text"><strong>${agencyInfo.name}</strong><small>Trusted LPG Service Partner</small></span></a>
                        <p>Safe cylinder delivery, dependable household LPG support and responsive local service—all from one trusted agency team.</p>
                    ...
                    <div class="footer-column"><h3>Explore</h3><ul><li><a href="index.html">Home</a></li><li><a href="products.html">LPG Products</a></li><li><a href="timeline.html">Our Journey</a></li><li><a href="gallery.html">Photo & Video Gallery</a></li><li><a href="certificates.html">Achievements</a></li><li><a href="nearby-agency.html">Location & Map</a></li></ul></div>
                    <div class="footer-column"><h3>LPG Support</h3><ul><li><a href="contact.html">New Connection Help</a></li><li><a href="contact.html">Refill Assistance</a></li><li><a href="gallery.html">Safety Guidance</a></li><li><a href="contact.html">Service Request</a></li><li><a href="contact.html">Emergency Support</a></li></ul></div>
            ...
            <div class="locator-enquiry reveal-up">
                ...
                <div class="enquiry-option-grid">
                    <a class="enquiry-option" href="contact.html"
                        ...
                        <div>
                            <small>Household Support</small>
                            <h3>Domestic LPG Assistance</h3>
...
const introAnchor = document.querySelector("main > .hero, main > .page-hero");
if (introAnchor) {
